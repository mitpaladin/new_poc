...
module MelddRepository
  # This is a dirt-simple little value object that gets kicked around to isolate
  # the underlying database implementation (ActiveRecord, Sequel or whatever)
  # from Other Stuff like DM repos and use cases.
  class StoreResult
  ...
  end # class MelddRepository::StoreResult
