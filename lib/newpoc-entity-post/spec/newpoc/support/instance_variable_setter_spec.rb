...
module Newpoc
  # Support classes shared between various Newpoc modules
  module Support
    ...
    describe InstanceVariableSetter do
      describe 'can be initialised using a' do
        ...
        # target object; we simply expect that ivars not explicitly permitted
        # *that are not otherwise initialised* have `nil` values.
        after :each do
    ...
    end # describe Newpoc::Support::InstanceVariableSetter
  end # module Newpoc::Support
end # module Newpoc
