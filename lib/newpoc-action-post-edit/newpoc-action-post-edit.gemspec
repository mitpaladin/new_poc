...
Gem::Specification.new do |spec|
  spec.name          = 'newpoc-action-post-edit'
  spec.version       = Newpoc::Action::Post::Edit::VERSION
  spec.authors       = ['Jeff Dickey']
  spec.email         = ['jdickey@seven-sigma.com']
  spec.summary       = %q{Verifies that the current user is permitted to edit a specified post.}
