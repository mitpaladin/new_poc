...
Gem::Specification.new do |spec|
  spec.name          = "newpoc-action-post-show"
  spec.version       = Newpoc::Action::Post::Show::VERSION
  spec.authors       = ["Jeff Dickey"]
  spec.email         = ["jdickey@seven-sigma.com"]
  spec.summary       = %q{Retrieves a Post on behalf of current user, for `new_poc`.}
  spec.description   = %q{Retrieves a Post on behalf of current user, for `new_poc`.}
