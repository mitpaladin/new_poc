...
describe UsersController::Action::Create::PasswordMatcher do
  ...
  describe 'has a #match method that' do
    ...
    it desc do
      ...
      expect { described_class.new(data).match }.not_to raise_error
    end

    describe 'raises an error when' do
      it 'the passwords do not match' do
        data = { password: 'password', password_confirmation: 'other password' }
        expect { described_class.new(data).match }.to raise_error do |e|
      ...
      it 'no passwords are specified' do
        ...
        expect { described_class.new(data).match }.to raise_error
      end
    end # describe 'raises an error when'
  end # describe 'has a #match method that'
end # describe UsersController::Action::Create::PasswordMatcher
